...
export const TradeOfferUncheckedCreateNestedManyWithoutCreatedByInputSchema: z.ZodType<Prisma.TradeOfferUncheckedCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
...
export default TradeOfferUncheckedCreateNestedManyWithoutCreatedByInputSchema;
