...
export const TradeRequestUncheckedUpdateManyInputSchema: z.ZodType<Prisma.TradeRequestUncheckedUpdateManyInput> =
  z
    .object({
      id: z
        .union([
...
export default TradeRequestUncheckedUpdateManyInputSchema;
