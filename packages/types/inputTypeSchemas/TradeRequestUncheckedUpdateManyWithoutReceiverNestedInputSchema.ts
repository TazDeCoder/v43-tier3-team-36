...
export const TradeRequestUncheckedUpdateManyWithoutReceiverNestedInputSchema: z.ZodType<Prisma.TradeRequestUncheckedUpdateManyWithoutReceiverNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default TradeRequestUncheckedUpdateManyWithoutReceiverNestedInputSchema;
