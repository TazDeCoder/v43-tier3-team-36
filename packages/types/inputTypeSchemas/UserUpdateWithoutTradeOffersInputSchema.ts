...
export const UserUpdateWithoutTradeOffersInputSchema: z.ZodType<Prisma.UserUpdateWithoutTradeOffersInput> =
  z
    .object({
      id: z
        .union([
...
export default UserUpdateWithoutTradeOffersInputSchema;
