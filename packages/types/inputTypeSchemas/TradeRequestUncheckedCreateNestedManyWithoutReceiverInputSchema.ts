...
export const TradeRequestUncheckedCreateNestedManyWithoutReceiverInputSchema: z.ZodType<Prisma.TradeRequestUncheckedCreateNestedManyWithoutReceiverInput> =
  z
    .object({
      create: z
        .union([
...
export default TradeRequestUncheckedCreateNestedManyWithoutReceiverInputSchema;
