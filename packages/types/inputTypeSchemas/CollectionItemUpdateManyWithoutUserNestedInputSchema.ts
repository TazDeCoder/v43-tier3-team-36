...
export const CollectionItemUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.CollectionItemUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default CollectionItemUpdateManyWithoutUserNestedInputSchema;
