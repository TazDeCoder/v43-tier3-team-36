...
export const CollectionItemUncheckedUpdateManyWithoutTradeOfferNestedInputSchema: z.ZodType<Prisma.CollectionItemUncheckedUpdateManyWithoutTradeOfferNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default CollectionItemUncheckedUpdateManyWithoutTradeOfferNestedInputSchema;
