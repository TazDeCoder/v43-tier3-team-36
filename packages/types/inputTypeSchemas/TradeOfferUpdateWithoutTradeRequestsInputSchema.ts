...
export const TradeOfferUpdateWithoutTradeRequestsInputSchema: z.ZodType<Prisma.TradeOfferUpdateWithoutTradeRequestsInput> =
  z
    .object({
      id: z
        .union([
...
export default TradeOfferUpdateWithoutTradeRequestsInputSchema;
