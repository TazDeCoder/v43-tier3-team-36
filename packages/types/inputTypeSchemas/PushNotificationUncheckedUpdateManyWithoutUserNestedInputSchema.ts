...
export const PushNotificationUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.PushNotificationUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default PushNotificationUncheckedUpdateManyWithoutUserNestedInputSchema;
