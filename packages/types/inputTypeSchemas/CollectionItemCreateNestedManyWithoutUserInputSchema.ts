...
export const CollectionItemCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.CollectionItemCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export default CollectionItemCreateNestedManyWithoutUserInputSchema;
