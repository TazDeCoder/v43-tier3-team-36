...
export const CollectionItemUncheckedCreateNestedManyWithoutTradeOfferInputSchema: z.ZodType<Prisma.CollectionItemUncheckedCreateNestedManyWithoutTradeOfferInput> =
  z
    .object({
      create: z
        .union([
...
export default CollectionItemUncheckedCreateNestedManyWithoutTradeOfferInputSchema;
