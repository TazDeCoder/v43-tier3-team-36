...
export const TradeRequestUpdateManyWithoutTradeOfferNestedInputSchema: z.ZodType<Prisma.TradeRequestUpdateManyWithoutTradeOfferNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default TradeRequestUpdateManyWithoutTradeOfferNestedInputSchema;
