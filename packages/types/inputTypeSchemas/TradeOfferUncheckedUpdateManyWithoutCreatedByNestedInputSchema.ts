...
export const TradeOfferUncheckedUpdateManyWithoutCreatedByNestedInputSchema: z.ZodType<Prisma.TradeOfferUncheckedUpdateManyWithoutCreatedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default TradeOfferUncheckedUpdateManyWithoutCreatedByNestedInputSchema;
