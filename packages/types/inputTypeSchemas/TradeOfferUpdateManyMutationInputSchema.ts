...
export const TradeOfferUpdateManyMutationInputSchema: z.ZodType<Prisma.TradeOfferUpdateManyMutationInput> =
  z
    .object({
      id: z
        .union([
...
export default TradeOfferUpdateManyMutationInputSchema;
