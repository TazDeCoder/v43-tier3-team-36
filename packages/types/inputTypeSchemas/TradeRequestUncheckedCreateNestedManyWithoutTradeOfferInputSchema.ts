...
export const TradeRequestUncheckedCreateNestedManyWithoutTradeOfferInputSchema: z.ZodType<Prisma.TradeRequestUncheckedCreateNestedManyWithoutTradeOfferInput> =
  z
    .object({
      create: z
        .union([
...
export default TradeRequestUncheckedCreateNestedManyWithoutTradeOfferInputSchema;
