...
export const PushNotificationCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.PushNotificationCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export default PushNotificationCreateNestedManyWithoutUserInputSchema;
