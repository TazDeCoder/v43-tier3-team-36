...
export const TradeRequestFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TradeRequestFindUniqueOrThrowArgs> =
  z
    .object({
...
export default TradeRequestFindUniqueOrThrowArgsSchema;
