...
export const TradeOfferFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TradeOfferFindUniqueOrThrowArgs> =
  z
    .object({
...
export default TradeOfferFindUniqueOrThrowArgsSchema;
