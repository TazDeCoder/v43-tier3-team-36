...
export const CollectionItemFindFirstOrThrowArgsSchema: z.ZodType<Prisma.CollectionItemFindFirstOrThrowArgs> =
  z
    .object({
...
export default CollectionItemFindFirstOrThrowArgsSchema;
