...
export const TradeRequestFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TradeRequestFindFirstOrThrowArgs> =
  z
    .object({
...
export default TradeRequestFindFirstOrThrowArgsSchema;
